"""Unit tests for nautobot_ssot_demo."""
...
class DemoSSoTAPIViewTest(APIViewTestCases.APIViewTestCase):
    # pylint: disable=too-many-ancestors
    """Test the API viewsets for DemoSSoT."""
    ...
    def setUpTestData(cls):
        """Create test data for DemoSSoT API viewset."""
        super().setUpTestData()

...
```no-highlight
> poetry version
nautobot-ssot-demo 1.0.0-beta.2
```
...
Draft a [new release](https://github.com/netnam/nautobot-app-ssot-demo/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/netnam/nautobot-app-ssot-demo/pull/123` -> `* @nautobot_user`.
...
**Full Changelog**: https://github.com/netnam/nautobot-app-ssot-demo/compare/v1.4.1...v1.4.2
```
